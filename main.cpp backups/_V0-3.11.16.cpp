...
//                        vector< vector<char> > backupBlockPos(l, vector<char>(w));
                        //cout<<endl<<"w: "<<w<<" l: "<<l<<endl;
                        //cout<<"New world:"<<endl;
                        for(int x=0; x<w; x++)
                        {
                            //cout<<"x: "<<x;
                            ...
                            for (int y=l-1; y>=0; y--)
                            {
                                //cout<<" y: "<<y<<" xCounter: "<<xCounter<<endl;
                        ...
                        //cout<<"w: "<<w<<" l: "<<l<<" px: "<<playerX<<" py: "<<playerY<<endl;
                        int tempW=playerY;
                        playerY=playerX;
                        playerX=l-tempW-1;
                        tempW=w;
...
//                        vector< vector<char> > backupBlockPos(l, vector<char>(w));
                        ...
                        for(int x=w-1; x>=0; x--)
                        {
                            ...
                            {
                                //cout<<" y: "<<y<<" xCounter: "<<xCounter<<endl;
                                blockPos[xCounter][yCounter]=backupBlockPos[x][y];
                                cout<<backupBlockPos[x][y];
                                xCounter++;
                                //cout<<
                            }
