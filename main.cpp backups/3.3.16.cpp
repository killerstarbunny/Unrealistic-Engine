                ...
                if(blockPos[x][y]=='1')//if it's a block we gotta render
                {
                            ...
                            ***************************/
                            ...
                            if(i==1)//if this is the top of the box
                            {
                                ...
                                *****************/
                                ...
                                worldX=(79*degree)/(FOV*2);//when fov stuff is fixed this might need to be kept like this, or maybe this will be needed to help fix the vertical stretch. It's possible the stretch is simply because chars aren't square
                    ...
                    ***************/
                    ...
                    if(render[0]==true)
                    {
                        ...
                        {
                            for(int y=x*m1+b1; y<=x*m2+b2; y++)//y=slope of top checking if y<=slope of bottom
                            {
                                //cout<<"y: "<<y<<endl;
                                int tempa, tempb;
